...
//import static Tilemaps.Assets.BookPile;
...
public class World {
    ...
    public World(Handler handler, EntityManager entityM, String path) {
        ...
        entityManager.addEntity(new BookPile(handler, entityM, 500,500));
        entityManager.addEntity(new BookPile(handler, entityM, 120,600));
        entityManager.addEntity(new BookPile(handler, entityM, 800,400));
        entityManager.addEntity(new BookPile(handler, entityM, 730,188));
        loadWorld(path);
